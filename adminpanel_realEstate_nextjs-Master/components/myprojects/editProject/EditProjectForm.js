...
import {
 ReactstrapInput,
 ReactstrapSelect,
} from "../../../components/utils/ReactStarpInputsValidation";
import { updateProject } from "../../../lib/actions/projectaction";
...
const EditProjectForm = () => {
    ...
    useEffect(() => {
    setCurrentProject(project?.find((i) => i.slug === slug));
    
    }, [project, currentProject]);
    console.log({ currentProject, initialValues });
    ...
    if (listingInputFields.length < 3) {
 ...
 <Formik
      ...
      location_area: currentProject?.location_area,
      life_style: currentProject?.life_style,
      map_pin: currentProject?.map_pin,
      starting_price: currentProject?.starting_price,
      images: [],
      yt_video: currentProject?.yt_video,
      developer_name: currentProject?.developer_name,
      first_installment: currentProject?.first_installment,
      construction_status: currentProject?.construction_status,
      handover_status: currentProject?.handover_status,
      blue_prints: [],
      features: currentProject?.features,
      description: currentProject?.description,
      listing: currentProject?.listing,
      }}
      ...
      console.log(project);
      dispatch(updateProject(slug, project));
      ...
      {({ handleSubmit, values, setFieldValue }) => (
        <Form onSubmit={handleSubmit}>
          ...
          <Button type="reset" className="btn btn-dashed btn-pill">
          Cancel
          </Button>
          </Col>
          </Row>
